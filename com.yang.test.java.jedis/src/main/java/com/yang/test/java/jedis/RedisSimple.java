...
//		JedisCluster j = new JedisCluster(nodes, 15000, 10000, 1, "123456", new GenericObjectPoolConfig());
		...
		l.add("h_equip_dispenser:000000301138");
		l.add("h_equip_dispenser:000000301165");
		l.add("h_equipment_map:XZGYL00001");
		l.add("h_equipment_map:XZGYL00002");
		l.add("h_equipment_map:XZGYL00003");
		l.add("h_equipment_map:XZGYL00004");
		for(String key : l) {
			j.del(key);
		}
