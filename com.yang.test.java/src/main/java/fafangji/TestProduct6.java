			...
			rl.add(new Runnable() {
				public void run() {
					try {
						...
						final HttpGet p = new HttpGet("http://"+ip+":3114/NewVendingMachine/goodscheck?mchinesn=91000000000000&ordersn="+orderNo+"&timestamp=1545793115&code=LYZH111111111101&sign=6794F8DF8F1B13FFCC3BDB7B8D2B6147&price=10&goodsId=lyzh01");
