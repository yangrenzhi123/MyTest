			...
			rl.add(new Runnable() {
				public void run() {
					try {
						...
						final HttpGet p = new HttpGet("http://"+ip+":3114/NewVendingMachine/getOrder?mchinesn=91000000000000&timestamp=1545793115&code=LYZH111111111101&sign=6794F8DF8F1B13FFCC3BDB7B8D2B6147");
