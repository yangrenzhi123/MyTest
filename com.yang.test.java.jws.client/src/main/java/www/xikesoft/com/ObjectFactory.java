...
public class ObjectFactory {
    ...
    private final static QName _GetValue_QNAME = new QName("http://example.org", "getValue");
    private final static QName _GetValueResponse_QNAME = new QName("http://example.org", "getValueResponse");
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://example.org", name = "getValue")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://example.org", name = "getValueResponse")
