...
public class App {
	public static void main(String[] args) {
        ...
        //Kafka服务监听端口
        kafkaParams.put("bootstrap.servers", "192.168.10.239:9092");
        ...
        try {
            // 获取kafka的数据
            final JavaInputDStream<ConsumerRecord<String, String>> stream = KafkaUtils.createDirectStream(jssc, LocationStrategies.PreferConsistent(), ConsumerStrategies.<String, String>Subscribe(topics, kafkaParams));
            ...
            JavaPairDStream<String, Integer> result2 = wordsAndOne.reduceByKeyAndWindow((Function2<Integer, Integer, Integer>) (x, y) -> x + y, Durations.seconds(15), Durations.seconds(5));
            result2.print();
