...
public class HiveJDBC {
	...
	private static String url = "jdbc:hive2://192.168.44.195:10000/default";
...
//		System.out.println("Running: " + sql);
//		stmt.execute(sql);
//		sql = "create EXTERNAL TABLE test_4_hbase(id int, name String) STORED BY 'org.apache.hadoop.hive.hbase.HBaseStorageHandler' WITH SERDEPROPERTIES(\"hbase.columns.mapping\" = \":key,f1:name\") TBLPROPERTIES(\"hbase.table.name\" = \"test\")";
//		System.out.println("Running: " + sql);
//		stmt.execute(sql);
