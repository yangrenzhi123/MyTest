...
public class FengKong {
	...
	public static void main(String[] args) throws Exception {
		...
		data.put("ext_rewardScore", 11.1);//投放奖励积分
        ...
        request.setFlag("activity_20200605003");
        /**创建一个客户端实例**/
