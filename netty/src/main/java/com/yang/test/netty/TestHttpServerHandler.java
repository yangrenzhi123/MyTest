...
public class TestHttpServerHandler extends SimpleChannelInboundHandler<HttpObject>{
    ...
    protected void channelRead0(ChannelHandlerContext ctx, HttpObject msg) throws Exception {
        if(msg instanceof HttpRequest){
            ...
            //设置要返回的内容长度
            response.headers().setInt(HttpHeaderNames.CONTENT_LENGTH, content.readableBytes()); //内容长度
            //将响应对象返回
	...
	@Override
	protected void messageReceived(ChannelHandlerContext arg0, HttpObject arg1) throws Exception {
